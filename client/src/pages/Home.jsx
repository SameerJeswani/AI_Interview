...
<div className="flex justify-center mb-6">
  <div className="flex flex-col items-center">
    ...
    <p className="mt-3 text-xs tracking-[0.25em] text-gray-400 text-center">
      DESIGNED & DEVELOPED BY SAMEER JESWANI
    </p>
  </div>
</div>
...
<div className="flex items-center justify-between w-full">
  ...
  <div className="max-w-[60%]">
    <h3 className="font-semibold text-xl mb-3 min-h-[60px]">
      {mode.title}
    </h3>
